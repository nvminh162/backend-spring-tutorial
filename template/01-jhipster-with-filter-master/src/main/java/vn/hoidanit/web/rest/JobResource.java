...
import vn.hoidanit.domain.Job;
import vn.hoidanit.repository.JobRepository;
import vn.hoidanit.service.JobQueryService;
import vn.hoidanit.service.JobService;
import vn.hoidanit.service.criteria.JobCriteria;
import vn.hoidanit.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link vn.hoidanit.domain.Job}.
 */
@RestController
...
public class JobResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Job>> getAllJobs(JobCriteria criteria, @org.springdoc.core.annotations.ParameterObject Pageable pageable) {
